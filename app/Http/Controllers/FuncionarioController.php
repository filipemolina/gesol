...
class FuncionarioController extends Controller
{
	...
	public function create()
	{
	  ...
	  return view ('funcionarios.create_funcionario',
			compact('funcionario_logado','secretarias','setores',
					 'servicos','roles','pode_alterar_secretaria','tipos'));
	}
	...
	public function edit(Funcionario $funcionario)
	{
	  ...
	  if($funcionario_logado->role->peso < $funcionario->role->peso)
	  {
		...
		return view('funcionarios.edit', compact('funcionario_logado','funcionario','secretarias','setores','servicos','roles','pode_alterar_secretaria','tipo'));
