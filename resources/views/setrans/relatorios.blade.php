		...
		<div class="card">
			<div class="card-header card-header-success card-header-icon">
				...
				<h4 class="card-title">Relatorios</h4>
					@if($setrans)
						<a href="{{ url("/setrans/create")}}" class="btn btn-dourado btn-just-icon btn-round" style="float: right;top: -33px;right: -13px;"><i class="mdi mdi-plus" rel="tooltip" data-placement="left" title="Novo Relatorio"></i></a>					
					@endif
			</div>
			<div class="card-body">
