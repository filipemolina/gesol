      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="card-content">
               <h4 class="card-title" style="width: 100% !important;">Solicitações Registradas</h4>
            </div>
            ...
            <div class="card-content" >
               <div  id='sol_maiores' style="height:250px" ></div>
            </div>
...
//      console.log(teste);
      ...
      // based on prepared DOM, initialize echarts instance
      var totalChart = echarts.init(document.getElementById('sol_maiores'));
